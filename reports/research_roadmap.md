...
2. Add an API-Football snapshot collector and immutable raw store. Run it at scheduled pre-match offsets so training and live inference see information from comparable times.
