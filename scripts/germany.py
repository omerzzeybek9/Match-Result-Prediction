...
api_key = "api_key"
standings_url = 'http://api.football-data.org/v4/competitions/BL1/standings'
matches_url = 'http://api.football-data.org/v4/competitions/BL1/matches'
...
df_combined.to_csv("initial_data/leagues/bundesliga_league_stats.csv", index=False)
