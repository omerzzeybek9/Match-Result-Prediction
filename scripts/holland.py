...
api_key = "api_key"
standings_url = 'http://api.football-data.org/v4/competitions/DED/standings'
matches_url = 'http://api.football-data.org/v4/competitions/DED/matches'
...
df_combined.to_csv("initial_data/leagues/eredivise_league_stats.csv", index=False)
