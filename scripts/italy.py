...
api_key = "api_key"
standings_url = 'http://api.football-data.org/v4/competitions/SA/standings'
matches_url = 'http://api.football-data.org/v4/competitions/SA/matches'
...
df_combined.to_csv("initial_data/leagues/seria_league_stats.csv", index=False)
