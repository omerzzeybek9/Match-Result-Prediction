...
api_key = "api_key"
standings_url = 'http://api.football-data.org/v4/competitions/PD/standings'
matches_url = 'http://api.football-data.org/v4/competitions/PD/matches'
...
df_combined.to_csv("initial_data/leagues/laliga_league_stats.csv", index=False)
